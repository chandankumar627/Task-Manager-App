...
import { Mail, Lock, User, Eye, EyeOff, UserPlus, CheckSquare } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(response.data || 'Registration successful! Please login.');
      navigate('/login');
    } catch (error) {
      console.error(error);
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl p-6 sm:p-8 border border-slate-800 shadow-2xl relative border-pulse-glow">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <p className="text-slate-400 text-xs sm:text-sm mt-1">
            Create an account to track your workspace workflow
          </p>
        </div>
